...
public interface IColors {
   ...
   //with FF alpha pre computed
   public static final int   FULLY_OPAQUE_BEIGE            = 0xFFFFFF80;

   public static final int   FULLY_OPAQUE_BLACK            = 0xFF000000;

   public static final int   FULLY_OPAQUE_BLUE             = 0xFF0000FF;

   public static final int   FULLY_OPAQUE_CYAN             = 0xFF00FFFF;

   public static final int   FULLY_OPAQUE_GREEN            = 0xFF00FF00;

   public static final int   FULLY_OPAQUE_GREY             = 0xFF808080;

   public static final int   FULLY_OPAQUE_ORANGE           = 0xFFFF8000;

   public static final int   FULLY_OPAQUE_PINK             = 0xFFFF80FF;

   public static final int   FULLY_OPAQUE_PURPLE           = 0xFFFF00FF;

   public static final int   FULLY_OPAQUE_RED              = 0xFFFF0000;

   public static final int   FULLY_OPAQUE_SKY_BLUE         = 0xFF0080FF;

   public static final int   FULLY_OPAQUE_SKY_GREEN        = 0xFF80FF80;

   public static final int   FULLY_OPAQUE_WHITE            = 0xFFFFFFFF;

   public static final int   FULLY_OPAQUE_YELLOW           = 0xFFFFFF00;

   public static final int   FULLY_TRANSPARENT_BLACK       = 0;

 
   public static final int   FZ128_BLUE                    = 0xFF000080;

   public static final int   FZ128_GREEN                   = 0xFF008000;

   public static final int   FZ128_GREEN_BLUE              = 0xFF008080;

   public static final int   FZ128_RED                     = 0xFF800000;

   public static final int   FZ128_RED_BLUE                = 0xFF800080; 

   public static final int   FZ128_RED_GREEN               = 0xFF808000;
